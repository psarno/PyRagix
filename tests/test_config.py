...
@pytest.fixture
def load_isolated_config() -> Callable[..., Any]:
    """Load the config module in an isolated namespace using temporary settings."""

    loaded_modules: list[str] = []

    def _loader(tmp_path: Path, *, module_name: str) -> Any:
        example_copy = tmp_path / "settings.example.toml"
        shutil.copy(EXAMPLE_SETTINGS, example_copy)
        ...
        try:
            ...
            assert spec.loader is not None  # mypy/runtime guard
